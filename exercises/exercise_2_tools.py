...
LEGAL_KNOWLEDGE = [
    ...
    {
        "id": "labor_law",
        "keywords": ["lao động", "sa thải", "hợp đồng lao động", "labor", "termination", "thời hiệu"],
        "text": (
            "Theo Bộ luật Lao động Việt Nam 2019, người sử dụng lao động có thể "
            "đơn phương chấm dứt hợp đồng trong các trường hợp: (1) người lao động "
            "thường xuyên không hoàn thành công việc; (2) bị ốm đau, tai nạn đã điều trị "
            "12 tháng chưa khỏi; (3) thiên tai, hỏa hoạn; (4) người lao động đủ tuổi nghỉ hưu. "
            "Thời hiệu khởi kiện tranh chấp lao động cá nhân là 1 năm kể từ ngày phát hiện hành vi vi phạm."
        ),
    },
]
...
def check_statute_of_limitations(case_type: str) -> str:
    ...
    limits = {
        ...
        "property": "5 năm",
        "labor": "1 năm kể từ ngày phát hiện vi phạm (Bộ luật Lao động VN 2019)",
    }
    return limits.get(case_type.lower(), "Không xác định — vui lòng tra cứu luật áp dụng cụ thể.")
